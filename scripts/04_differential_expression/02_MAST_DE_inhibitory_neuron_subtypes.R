...
obj <- readRDS(paste0("../rObjects/subclusters/", project_ID, "_interneuron_subclustered.rds"))
DefaultAssay(obj) <- "RNA"

table(obj$subcluster)
...
pdf_name <- paste0("../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/inhibitory_neuron/UMAP_clusters_and_subtype_annotation.pdf")
...
pdf_name <- paste0("../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/inhibitory_neuron/UMAP.rpca_subtype_annotation.pdf")
pdf(pdf_name, width = 6, height = 6)
print(p3)
dev.off()


table(obj.annotated$subtype)
...
count_bar
pdf_name <- paste0("../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/inhibitory_neuron/subtype_count_per_group.pdf")
pdf(pdf_name, width = 6, height = 6)
print(count_bar)
dev.off()
...
out_base <- "../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/inhibitory_neuron/"
