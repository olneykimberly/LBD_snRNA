...
obj$celltype_group_sex <- paste(obj$cell_type, obj$group, obj$sex_inferred, sep = "_")
Idents(obj) <- "celltype_group_sex"
...
out_base <- "../results/DEGs_RNA_pct0.25_by_sex/"
...
for (ct in cell_types) {
  ...
  Idents(obj_ct) <- "celltype_group_sex"
