...
obj <- readRDS(paste0("../rObjects/subclusters/", project_ID, "_astrocyte_subclustered.rds"))
...
pdf_name <- paste0("../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/astrocyte/UMAP_clusters_and_subtype_annotation.pdf")
...
pdf_name <- paste0("../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/astrocyte/UMAP.rpca_clusters_and_subtype_annotation.pdf")
...
count_bar
pdf_name <- paste0("../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/astrocyte/subtype_count_per_group.pdf")
pdf(pdf_name, width = 6, height = 6)
print(count_bar)
dev.off()
...
out_base <- "../results/DEG_MAST_RNA_pct0.25_celltype_subtypes/astrocyte/"
