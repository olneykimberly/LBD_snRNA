...
output_dir <- "../results/volcanoes_MAST/"
```
...
for (comp in comparisons) {
  ...
  for (cell in cell_types) {
    ...
    filepath <- paste0("../results/DEGs_RNA_pct0.25/", cell, 
  ...
  if (length(list_of_datasets) > 0) {
    output_file <- paste0("../results/DEGs_RNA_pct0.25/", comp_name, ".xlsx")
...
output_dir <- "../results/DEGs_RNA_pct0.25/"
final_volcano_dir <- "../results/volcanoes_MAST/"
