...
```{r volcano_group, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DEGs_rpca/", i, "_LBD-ATS_vs_CONTROL_comparison_pseudobulk.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DEGs_rpca/", i, "_LBD-ATS_vs_CONTROL.pdf"), height = 7, width = 7)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
```{r volcano_group, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DEGs_rpca/", i, "_LBD-AS_vs_CONTROL_comparison_pseudobulk.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DEGs_rpca/", i, "_LBD-AS_vs_CONTROL.pdf"), height = 7, width = 7)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
```{r volcano_group, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DEGs_rpca/", i, "_LBD-S_vs_CONTROL_comparison_pseudobulk.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DEGs_rpca/", i, "_LBD-S_vs_CONTROL.pdf"), height = 7, width = 7)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
...
```{r volcano_group, warning=FALSE}
for (i in cell_types) {
  ind1_vs_ind2 <- read.delim(paste0("../results/DEGs/DEGs_rpca/", i, "_AD-AT_vs_CONTROL_comparison_pseudobulk.txt"))
  ind1_vs_ind2 <- na.omit(ind1_vs_ind2)
  if (!any(ind1_vs_ind2$padj < 0.1, na.rm = TRUE)) {
    # If there are no significant DEGs, create a volcano plot with all points in gray
    p <- ggplot(data = ind1_vs_ind2, aes(x = log2FoldChange, y = -log10(pvalue))) +
    ...
    pdf(paste0("../results/volcanoes/DEGs_rpca/", i, "_AD-AT_vs_CONTROL.pdf"), height = 7, width = 7)
    print(p)
    dev.off()
  } else {
    color_values <- vector()
