...
#SBATCH -n 8 # threaded 
#SBATCH --mem=64G 
#SBATCH -o slurm.0385.out
#SBATCH -e slurm.0385.err
...
#snakemake -s Snakefile -j 32 --nolock --latency-wait 15 --cluster "sbatch --ntasks 1 --cpus-per-task=8 --mem=64G --time=60:00:00"
