...
output_dir <- "/tgen_labs/jfryer/kolney/LBD_CWOW/LBD_snRNA/results/UpSet/disease_vs_control" 
...
generate_upset_plot <- function(data, celltype, reg_status, comparison_names, dot_color) {
  ...
  sets_list <- list(
    short_comp_names[1], short_comp_names[2], short_comp_names[3], short_comp_names[4],
    c(short_comp_names[1], short_comp_names[2], short_comp_names[3], short_comp_names[4]),
    c(short_comp_names[4], short_comp_names[3], short_comp_names[2]),
    c(short_comp_names[4], short_comp_names[1], short_comp_names[3]),
    c(short_comp_names[4], short_comp_names[1], short_comp_names[2]),
    c(short_comp_names[4], short_comp_names[1]),
    c(short_comp_names[4], short_comp_names[3]),
    c(short_comp_names[4], short_comp_names[2]),
    c(short_comp_names[2], short_comp_names[3]),
...
for (ct in cell_types) {
  ...
  p_combined <- plot_grid(
    ...
    p_up,         # Panel C
    ncol = 3,
    rel_widths = c(1, 1.5, 1.5), # Adjust widths to prioritize the UpSet complexity
    labels = c("A", "B", "C"),
    label_size = 10,
