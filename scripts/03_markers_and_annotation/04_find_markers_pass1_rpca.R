...
write.table(markers, 
            paste0("../results/markers/", project_ID, "_markers.tsv"),
            quote = FALSE,
            row.names = FALSE)
saveRDS(markers, paste0("../rObjects/", project_ID, "_markers.rds"))
...
saveRDS(all.markers.strict, paste0("../rObjects/", project_ID,"_markers_log2FC1_q0.01.rds"))
